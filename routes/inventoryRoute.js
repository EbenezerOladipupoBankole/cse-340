...
router.get("/", utilities.handleErrors(invManagementController.buildManagement))

// Route to build add classification view
router.get("/add-classification", utilities.handleErrors(invManagementController.buildAddClassification))
